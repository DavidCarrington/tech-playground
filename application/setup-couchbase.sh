...
curl -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD -v http://couchbase.one:8091/controller/addNode -d 'hostname=couchbase.three&user=$COUCHBASE_ADMIN_USERNAME&password=$COUCHBASE_ADMIN_PASSWORD&services=kv'

# Rebalance
curl -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD -v http://couchbase.one:8091/controller/rebalance -d 'knownNodes=ns_1@couchbase.one,ns_1@couchbase.two,ns_1@couchbase.three'
